...
export const services: Service[] = [
  ...
  },
  {
    ...
    detail: [
      ...
      'If you want a talking intro, I can shoot you on the front walk at the start of the video. Bring what you want to say — it works better than reading a script off a phone.',
    ],
    includes: [
  ...
  },
  {
    ...
    detail: [
      ...
      'I fly under an FAA Part 107 remote pilot certificate. That matters on a paid listing: a hobbyist flying your shoot is not legal, and it is your brokerage that gets the letter.',
      'Class G airspace around Oxford is straightforward. Tupelo sits under controlled airspace and needs a LAANC authorization, which I pull the day before — no added cost, just a reason not to book that one same-day.',
    ],
    includes: [
  ...
  },
  {
    ...
    detail: [
      ...
      'It takes preparation on your side: every interior light on, every blind open, cars off the driveway, and the porch lights working. I send a one-page checklist when a twilight is on the order.',
      'Weather kills more twilights than anything else. If the sky is flat gray, I will tell you before I drive out and we reschedule instead of shooting something you would not post.',
    ],
    includes: [
  ...
  },
  {
    ...
    detail: [
      ...
      'I laser-measure on site while I am already there shooting, so it does not add a second appointment. Room labels and dimensions are included, and a black-on-white and a white-on-dark version both come in the folder.',
      'These are marketing floor plans, drawn from my own measurements. They are not an appraisal and not a survey — if your MLS requires a certified square footage figure, use the county or an appraiser for that number.',
    ],
    includes: [
  ...
  },
  {
    ...
    stamp: ['72 HR DELIVERY', 'PER IMAGE'],
    size: 'compact',
    ratio: [4, 3],
    detail: [
      ...
      'You pick the direction — transitional, traditional, or something closer to what sells in that neighborhood — and I furnish the room to match the scale of the space rather than filling it.',
      'Every staged image is delivered with a "virtually staged" label baked into the corner, and I recommend keeping the empty original in the gallery next to it. Most MLS rules require the disclosure, and buyers trust the listing more when both are there.',
    ],
    includes: [
